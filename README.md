...
- 当前发布基线为 AppVolume 1.0.3（Build 5），公开发布时间为 2026-08-29 17:13:07 UTC（北京时间 2026-08-30 01:13:07）。发布历史包含 1.0.0、1.0.1、1.0.2 和 1.0.3。
...
- 更新日志同时展示已发布版本和公开规划。1.0.3 是维护版本，核心音频功能保持不变；规划项不代表具体交付版本或日期承诺。
